...
#     assert isinstance(transaction_bill, BaseBill)

#     assert transaction_bill.get_remaining_min() == Decimal("0")

#     assert transaction_bill.get_remaining_max() == Decimal("1200")

#     assert user_loan.get_transaction_loans()[0].id == transaction_bill.id

#     _, unbilled_amount = get_account_balance_from_str(session, book_string=f"{bill_id}/bill/unbilled/a")
#     assert unbilled_amount == 1200

#     _, principal_receivable = get_account_balance_from_str(
#         session, book_string=f"{transaction_bill.id}/bill/principal_receivable/a"
#     )
#     assert principal_receivable == 1200
